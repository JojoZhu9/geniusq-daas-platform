...
import { DashboardManagementBar } from "./components/DashboardManagementBar";
import {
  compactIntoTwoColumns,
  dropTargetFromPointer,
  isLegacySingleColumn,
  layoutItem,
  layoutsOverlap,
  reflowAroundCard,
  type LayoutItem
    ...
    <section className="page-section dashboard-page">
      ...
      {!dashboard ? (
        ...
        <>
          ...
          <DashboardFilters filters={filters} options={filterOptions} onChange={setFilters} />
          <div
