...
2. 可在 Windows 本地运行的演示系统：在不修改极智 DAAS 源码的前提下，以独立前后端项目完整展示石墨文档“智能问数优化需求 0714”中的关键能力。
...
- Demo 保留现有极智 DAAS 的深色顶栏、蓝色激活态、左侧模块导航和数据工作台视觉结构。
...
- Demo 不实现生产级身份认证、多人实时协作、真实定时任务调度、生产数据连接器和极智 DAAS 源码合并。
...
- 页面视觉结构与用户提供的极智 DAAS 截图一致，但不复制公司专有源代码或生产数据。
